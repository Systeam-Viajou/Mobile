...
public class HomeExperienciaAdapter extends RecyclerView.Adapter<HomeExperienciaAdapter.HomeViewHolder>{

    private List<Home> homeList;
    private Context context;

    public HomeExperienciaAdapter(List<Home> homeList, Context context) {
    ...
    @NonNull
    @Override
    public HomeExperienciaAdapter.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_card_home, parent, false);
        return new HomeExperienciaAdapter.HomeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeExperienciaAdapter.HomeViewHolder holder, int position) {
