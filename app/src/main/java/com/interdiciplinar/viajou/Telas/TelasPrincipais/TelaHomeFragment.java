...
public class TelaHomeFragment extends Fragment {
    ...
    private HomeRecomendarAdapter recomandarAdapter;
    private List<Home> continuarList, recomendarlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recomandarAdapter = new HomeRecomendarAdapter(recomendarlist, getContext());
        recyclerRecomendar.setAdapter(recomandarAdapter);
