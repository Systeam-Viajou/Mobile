...
public class HomePertoAdapter extends RecyclerView.Adapter<HomePertoAdapter.HomeViewHolder>{

    private List<Home> homeList;
    private Context context;

    public HomePertoAdapter(List<Home> homeList, Context context) {
    ...
    @NonNull
    @Override
    public HomePertoAdapter.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_card_home, parent, false);
        return new HomePertoAdapter.HomeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HomePertoAdapter.HomeViewHolder holder, int position) {
